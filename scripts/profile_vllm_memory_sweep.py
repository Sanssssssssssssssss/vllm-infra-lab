...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model-path", default="/mnt/e/GPTProject2/vLLM/models/Qwen3-8B-GGUF/Qwen3-8B-Q4_K_M.gguf")
    parser.add_argument("--tokenizer-path", default="/mnt/e/GPTProject2/vLLM/models/Qwen3-8B")
    parser.add_argument("--hf-config-path", default="/mnt/e/GPTProject2/vLLM/models/Qwen3-8B")
